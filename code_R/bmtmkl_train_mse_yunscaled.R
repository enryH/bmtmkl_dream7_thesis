...
bmtmkl_mse_yunscaled <- function(Km, y, parameters) {
  ...
  if (parameters$progress == 1) {
    state <- list(lambda = lambda, upsilon = upsilon, a = a, G = G,  gamma = gamma, omega = omega, epsilon = epsilon, be = be, bounds = bounds, parameters = parameters, MSE_insample = lMSE_insample, MSE_outofsample = lMSE_outofsample)
  }
  else {
    state <- list(lambda = lambda, upsilon = upsilon, a = a, G = G, gamma = gamma, omega = omega, epsilon = epsilon, be = be, parameters = parameters, MSE_insample = lMSE_insample, MSE_outofsample = lMSE_outofsample)
  }
}
